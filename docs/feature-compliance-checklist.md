...
- **Core paths**: src/graph_agent/__main__.py, src/graph_agent/settings.py
...
- **Core paths**: src/graph_agent/__init__.py
- **Primary contracts**: 0 error codes, 0 events
- `[Covered By: tests/test_public_api_contract.py::test_known_missing_vendor_only_symbols_are_locked_as_external_consumer_debt]`
...
- **Sources**: skill-spec, source-file-map
- **Core paths**: src/graph_agent/core/parser.py, src/graph_agent/core/skill_parser.py
- **Primary contracts**: 0 error codes, 0 events
...
- **Sources**: public-api, source-file-map
- **Core paths**: src/graph_agent/core/loader.py, src/graph_agent/core/manifest.py
...
- **Sources**: public-api, source-file-map
- **Core paths**: src/graph_agent/core/graph_assembler.py, src/graph_agent/core/loader.py, src/graph_agent/core/manifest.py
...
- **Sources**: public-api, source-file-map
- **Core paths**: src/graph_agent/core/actions.py, src/graph_agent/core/phase_nodes/code_phase_node.py
...
- **Sources**: public-api, source-file-map
- **Core paths**: src/graph_agent/core/builtin_subagents/reference_reader.py, src/graph_agent/core/subagents.py
...
- **Sources**: skill-spec, source-file-map
- **Core paths**: src/graph_agent/core/mentions.py
...
- **Sources**: skill-spec, source-file-map
- **Core paths**: src/graph_agent/tools/builtin/read_example.py, src/graph_agent/tools/builtin/read_reference.py
...
- **Sources**: public-api, source-file-map
- **Core paths**: src/graph_agent/core/local_workspace_resolver.py, src/graph_agent/core/skill_resolver_protocol.py
...
- **Sources**: public-api, source-file-map
- **Core paths**: src/graph_agent/core/compiler.py, src/graph_agent/core/graph_builder.py
- **Primary contracts**: 2 error codes, 0 events
...
- **Sources**: public-api, source-file-map
- **Core paths**: src/graph_agent/cognitive/context_facade.py, src/graph_agent/core/callback_bridge.py
...
- **Sources**: public-api, source-file-map
- **Core paths**: src/graph_agent/core/io_manager.py, src/graph_agent/core/run_context.py
...
- **Sources**: skill-spec, source-file-map
- **Core paths**: src/graph_agent/core/cache.py, src/graph_agent/core/checkpointer.py
- **Primary contracts**: 0 error codes, 0 events
...
- **Sources**: public-api, source-file-map
- **Core paths**: src/graph_agent/callbacks/base.py, src/graph_agent/callbacks/emit.py
...
- **Sources**: public-api, source-file-map
- **Core paths**: src/graph_agent/callbacks/tracing.py, src/graph_agent/core/tracing_proxy.py
- **Primary contracts**: 0 error codes, 0 events
...
- **Sources**: public-api, source-file-map
- **Core paths**: src/graph_agent/core/error_registry.py, src/graph_agent/core/exceptions.py
...
- **Sources**: public-api, source-file-map
- **Core paths**: src/graph_agent/cognitive/critic.py, src/graph_agent/cognitive/memory.py
...
- **Sources**: public-api, source-file-map
- **Core paths**: src/graph_agent/models/__init__.py
...
- **Sources**: public-api, source-file-map
- **Core paths**: src/graph_agent/core/skill_tool_factory.py
...
- **Sources**: public-api, source-file-map
- **Core paths**: src/graph_agent/cognitive/finish.py, src/graph_agent/cognitive/finish_task.py
- **Primary contracts**: 0 error codes, 0 events
...
- **Sources**: skill-spec, source-file-map
- **Core paths**: src/graph_agent/cognitive/md2json.py, src/graph_agent/cognitive/md_patch.py
- **Primary contracts**: 0 error codes, 0 events
...
- **Sources**: skill-spec, source-file-map
- **Core paths**: src/graph_agent/core/module_sandbox.py, src/graph_agent/core/tool_wrapper.py
- **Primary contracts**: 0 error codes, 0 events
...
- **Sources**: skill-spec, source-file-map
- **Core paths**: src/graph_agent/tools/builtin/context_access.py, src/graph_agent/tools/builtin/read_file.py
- **Primary contracts**: 0 error codes, 0 events
...
- **Sources**: skill-spec, source-file-map
- **Core paths**: src/graph_agent/cognitive/middlewares.py
- **Primary contracts**: 0 error codes, 0 events
...
- **Sources**: skill-spec, source-file-map
- **Core paths**: src/graph_agent/middleware/cognitive_flow.py, src/graph_agent/middleware/execution_control.py
- **Primary contracts**: 0 error codes, 0 events
...
- **Sources**: public-api, source-file-map
- **Core paths**: src/graph_agent/core/_predict_internal/exporter.py, src/graph_agent/core/_predict_internal/hash.py
- **Primary contracts**: 0 error codes, 0 events
...
- **Sources**: public-api, source-file-map
- **Core paths**: src/graph_agent/callbacks/serialize.py, src/graph_agent/core/graph_serializer.py
- **Primary contracts**: 0 error codes, 0 events
...
- **Sources**: public-api, source-file-map
- **Core paths**: src/graph_agent/core/graph_assembler.py, src/graph_agent/core/phase_nodes/_helpers.py
- **Primary contracts**: 0 error codes, 0 events
...
- **Sources**: skill-spec, source-file-map
- **Core paths**: src/graph_agent/bootstrap.py, src/graph_agent/patches/__init__.py
- **Primary contracts**: 0 error codes, 0 events
...
- **Sources**: public-api, source-file-map
- **Core paths**: src/graph_agent/callbacks/logging_cb.py, src/graph_agent/callbacks/metrics.py
- **Primary contracts**: 0 error codes, 0 events
...
- **Sources**: public-api, source-file-map
- **Core paths**: src/graph_agent/cognitive/ambiguity.py, src/graph_agent/cognitive/clarification_middleware.py
...
- **Sources**: skill-spec, source-file-map
- **Core paths**: src/graph_agent/tools/builtin/parallel_map.py
- **Primary contracts**: 0 error codes, 2 events
...
- **Sources**: skill-spec, source-file-map
- **Core paths**: src/graph_agent/examples/hello_world/script/greet.py, src/graph_agent/io/manager.py
- **Primary contracts**: 0 error codes, 1 events
