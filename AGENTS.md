...
The current checkout contains the implemented Phase 1 typed runtime foundation, the Phase 2 portable gSkill format cutover, and the Phase 3 durable host-native handoff subset for explicitly serializable Agent wait points in a root DAG.
