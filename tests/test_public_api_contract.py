...
EXPECTED_SIGNATURES: dict[str, tuple[str, tuple[tuple[str, str, str, str], ...], str]] = {'PredictGatewayChatModel': ('graph_agent.core._predict_internal.interception',
 ...
 'assemble_graph': ('graph_agent',
                    (('compiled', 'POSITIONAL_OR_KEYWORD', '<required>', 'CompiledSkill'),
                     ...
                     ('skill_resolver',
                      'KEYWORD_ONLY',
                      'None',
                      'graph_agent.core.skill_resolver_protocol.SkillResolverProtocol | None'),
                     ('llm_provider',
                      'KEYWORD_ONLY',
                      'None',
                     ...
                     ('runtime_config', 'KEYWORD_ONLY', 'None', 'dict[str, Any] | None'),
                     ('pause_before', 'KEYWORD_ONLY', 'frozenset()', 'frozenset[str]'),
 ...
 'compile_skill': ('graph_agent',
                   (('root', 'POSITIONAL_OR_KEYWORD', '<required>', 'str | Path'),
                    ...
                    ('skill_resolver', 'KEYWORD_ONLY', 'None', 'SkillResolverProtocol | None'),
                    ('runtime_input_fields',
                     'KEYWORD_ONLY',
                     'None',
                     'dict[str, set[str]] | None'),
                    ('allowed_roles', 'KEYWORD_ONLY', 'None', 'set[str] | None')),
                   'CompiledSkill'),
...
EXPECTED_FIELD_CONTRACTS: dict[str, tuple[str, tuple[tuple[str, str], ...]]] = {'AgentNodeAST': ('graph_agent.core.manifest',
 ...
 'RunResult': ('graph_agent',
               (('success', 'bool'),
                ...
                ('paused_at', 'graph_agent.core.result.PausedRunPoint | None')))}
