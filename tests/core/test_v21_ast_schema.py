...
def test_logic_node_ast_schema_matches_golden() -> None:
    assert LogicNodeAST.model_json_schema() == _load_golden("logic_node_ast.schema.json"), (
        _UPDATE_HINT
    )


def test_subgraph_node_ast_schema_matches_golden() -> None:
    assert SubgraphNodeAST.model_json_schema() == _load_golden("subgraph_node_ast.schema.json"), (
        _UPDATE_HINT
    )
...
def test_phase_ast_union_schema_matches_golden() -> None:
    assert TypeAdapter(PhaseAST).json_schema() == _load_golden("phase_ast_union.schema.json"), (
        _UPDATE_HINT
    )
