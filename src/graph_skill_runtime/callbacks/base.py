...
the :class:`~graph_skill_runtime.callbacks.events.CallbackEvent` union it receives.
That is the whole surface: one method, one typed argument. Emitters reach it
through :func:`~graph_skill_runtime.callbacks.emit._safe_emit_event`, which is the only
