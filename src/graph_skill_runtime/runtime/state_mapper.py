"""Unified graph-skill-runtime WorkflowState state and IO mapping helpers."""
...
from graph_skill_runtime.callbacks.events import PhaseOutcome
from graph_skill_runtime.core.edge_transition import active_phase_execution_id
...
class PhaseWrapper:
    ...
    def wrap(
        ...
        if getattr(node, "__graph_skill_runtime_phase_wrapped__", False):
            wrapped_kind = getattr(node, "__graph_skill_runtime_phase_node_kind__", "unknown")
        ...
        wrapped_attrs.__graph_skill_runtime_phase_wrapped__ = True
        wrapped_attrs.__graph_skill_runtime_phase_node_kind__ = self.node_kind
        return _wrapped
