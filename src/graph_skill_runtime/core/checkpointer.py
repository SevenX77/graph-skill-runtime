...
def get_checkpointer(
    ...
    *,
    ...
    read graph_skill_runtime application config.
    """
...
def resolve_checkpointer(checkpointer_arg: Any = "auto") -> Checkpointer | None:
    ...
    If STUDIO_CHECKPOINTER is not set, it falls back to GRAPH_SKILL_RUNTIME_CHECKPOINTER_DB
    ...
    if checkpointer_arg == "auto":
        ...
        # Fallback to GRAPH_SKILL_RUNTIME_CHECKPOINTER_DB
        db_path = os.environ.get("GRAPH_SKILL_RUNTIME_CHECKPOINTER_DB")
