...
from graph_skill_runtime.callbacks.emit import _GatewayEventSink
from graph_skill_runtime.tracing.steps import LlmCallStep, StepReporter
...
class LLMProviderChatModel(BaseChatModel):
    ...
    def _llm_type(self) -> str:
        return "graph_skill_runtime_llm_provider"
