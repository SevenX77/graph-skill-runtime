...
from graph_skill_runtime.core._predict_internal.strategy import BaseMockStrategy, MockedSource
...
class _PredictGatewayChatModelMixin:
    ...
    def _generate(
        ...
        **kwargs: Any,
        ...
        # Imported here, not at module scope: `graph_skill_runtime.middleware.__init__`
        # reaches back into `core.runner`, so a top-level import closes a cycle.
        from graph_skill_runtime.middleware.invocation_scope import next_invocation_call_index
