...
This directory contains example skills demonstrating `graph_skill_runtime` capabilities.

## Quick Start

> Public SDK: `from graph_skill_runtime import run_skill, GraphAgentHarness, SkillManifest, ...` (see `graph_skill_runtime/__init__.py` for the 12 public exports).

### 1. Hello World (Minimal Example)

**Purpose**: Verify graph_skill_runtime installation and basic functionality.
...
result = run_skill(
    'src/graph_skill_runtime/examples/hello_world/SKILL.md',
...
**Expected output**:
```
Result: {'greeting': 'Hello, Developer! Welcome to graph_skill_runtime.', ...}
```
...
```python
from graph_skill_runtime import run_skill, TracingCallback
