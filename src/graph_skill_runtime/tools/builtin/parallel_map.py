...
def _emit_group_started(
    ...
    *,
    ...
    if not callbacks:
        return
    from graph_skill_runtime.callbacks.events import ParallelMapGroupStartedEvent
...
def _emit_group_ended(
    ...
    *,
    ...
    if not callbacks:
        return
    from graph_skill_runtime.callbacks.events import ParallelMapGroupEndedEvent
