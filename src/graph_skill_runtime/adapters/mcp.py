...
def create_server(application: RuntimeApplication | None = None) -> MCPServer[None]:
    ...
    @server.tool(name="compile", structured_output=True)
    ...
    @server.tool(name="resolve_run", structured_output=True)
    ...
    @server.tool(name="predict", structured_output=True)
    ...
    @server.tool(name="resume", structured_output=True)
    ...
    @server.tool(name="submit_agent_result", structured_output=True)
    ...
    @server.tool(name="inspect", structured_output=True)
    ...
    @server.tool(name="evaluate_golden", structured_output=True)
