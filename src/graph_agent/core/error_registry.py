...
ERROR_REGISTRY: dict[str, ErrorCodeMetadata] = {
    ...
    '[F-v3-agent-tool-reserved]': ErrorCodeMetadata('[F-v3-agent-tool-reserved]', 'FATAL', ('编译期',), 'docs/engine/mvp1/01-contract/02-skill-syntax/mvp1-alignment.md#2-语法部件清单--mvp1-写入状态'),
